...
export async function getServerSideProps() {
  ...
  const jalaliDate: string = format(today, 'yyyy/MM/dd', {
    locale: {
      options: { month: 'long' }, // Optional formatting options for the locale
      localize: new Date().toLocaleDateString('fa-IR'), // Localized date string
      formatLong: { month: 'long' }, // Optional long formatting options
    },
  });
